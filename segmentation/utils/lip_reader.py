...
# LIPReader(DATA_DIR, LIST_PATH, DATA_ID_LIST, INPUT_SIZE, RANDOM_SCALE, RANDOM_MIRROR, SHUFFLE, coord)
class LIPReader(object):
    ...
    def __init__(self, data_dir, data_list, data_id_list, input_size, random_scale,
        ...
        '''
        self.data_dir = data_dir #./datasets/lip
        self.data_list = data_list #./datasets/lip/list/train_rev.txt
        self.data_id_list = data_id_list #./datasets/lip/list/train_id.txt
        self.input_size = input_size #(384, 384)
